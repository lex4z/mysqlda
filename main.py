...
def btn1_click():
    ...
    output += f"Доля научно-педагогических работников, имеющих ученую степень: {n1}% - {is_valid1*"НЕ"} соответствует требованиям\n\n"

    is_valid2 = 0
    if n2 < pract_percent: is_valid2 = 1

    output += f"Доля работников из числа руководителей и(или) работников организаций, деятельность которых связана с направленностью реализуемой ОП: {n2}% = {is_valid2*"НЕ"} соответствует требованиям"
